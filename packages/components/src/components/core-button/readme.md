...
| `radius`      | `radius`       | Set to the value of border-radius applied. Default is 4(px).                                                                                                                                                                                                                              | `"0" \| "16" \| "2" \| "32" \| "4" \| "8" \| "circle"`                     | `"4"`       |
...
| `size`        | `size`         | The pre-defined button size. Use: `"small"`, `"default"`, or `"large"`.                                                                                                                                                                                                                   | `"default" \| "large" \| "small"`                                          | `"default"` |
| `status`      | `status`       | The status classing of the button. Use: `"success"`, `"danger"`, or `"warning"`.                                                                                                                                                                                                          | `"danger" \| "success" \| "warning"`                                       | `undefined` |
