...
| `class`     | `class`      | Passes any applied class                                                                                                                                                                      | `string`                   | `undefined` |
...
| `grouped`   | `grouped`    | Specifies the button-group styling if applied. Use: `"outline"`, or `"secondary"`.                                                                                                            | `"outline" \| "secondary"` | `undefined` |
