...
| `triggerCentered` | `trigger-centered` | Center the dropdown arrow on the trigger element, overwriting the `alignment` prop inheritance. Use when trigger elements are less than 30px wide, such as icons. | `boolean`                       | `false`  |
