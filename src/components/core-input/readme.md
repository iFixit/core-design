...
| `inputkeyboard` | `inputkeyboard` | A hint to the browser for which keyboard to display. Use: `"none"`, `"text"`, `"tel"`, `"url"`, `"email"`, `"numeric"`, `"decimal"`, and `"search"`.                                                                                                                                                                         | `"decimal" \| "email" \| "none" \| "numeric" \| "search" \| "tel" \| "text" \| "url"` | `undefined`    |
...
| `size`          | `size`          | Apply the large pre-defined input size and styling. Use: `"large"`.                                                                                                                                                                                                                                                          | `"large"`                                                                             | `undefined`    |
